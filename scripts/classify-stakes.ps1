...
$govGlobs = @('.cockpit/state/stakes-manifest.json', 'scripts/classify-stakes.ps1', 'scripts/run-governance-gate.ps1', 'scripts/write-verification-receipt.ps1', 'scripts/emit-verification-trailer.ps1', 'scripts/audit-verification-trailers.ps1', 'scripts/resolve-audit-range.ps1', 'scripts/lib/change-identity.ps1', 'scripts/lib/receipt-check.ps1', '.cockpit/state/governance-gate-exceptions.json')
