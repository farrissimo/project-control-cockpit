...
const appGlobals = { PCCOverview: 'readonly', PCCVerification: 'readonly', PCCStakes: 'readonly', PCCProvingWindow: 'readonly', PCCChatHealth: 'readonly', PCCRolloverSeed: 'readonly', PCCUsageProtection: 'readonly', PCCContinuedBuild: 'readonly', PCCNearestLimit: 'readonly' };
